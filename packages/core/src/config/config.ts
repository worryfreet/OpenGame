...
export class Config {
  ...
  async createToolRegistry(
    ...
    registerCoreTool(GenerateOneShotCoursePlanTool);
    registerCoreTool(GenerateCoursePlanTool, this);
    registerCoreTool(ScoreCourseQualityTool);
    registerCoreTool(RepairCourseGenerationTool);
    registerCoreTool(RecordCourseExperienceTool);
